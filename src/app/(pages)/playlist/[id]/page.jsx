...
// ✅ Playlist sidebar content component WITH IMAGES
  ...
  return (
    <>
      {playlists.map((playlist) => (
        ...
        >
          <div
            className={`flex items-center gap-3 p-2 rounded-md hover:bg-[#1a1a1a] transition cursor-pointer group ${
              currentId === playlist.id ? "bg-[#1a1a1a]" : ""
            }`}
          >
                  ...
                  <div className="space-y-1">
                    {songs.map((song, index) => (
                      <div
                        ...
                        className={`grid grid-cols-[16px_4fr_2fr_1fr] gap-4 px-4 py-3 rounded hover:bg-white/10 cursor-pointer group ${
