    ...
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        <div className="p-5 border-b border-white/5 flex items-center justify-between">
          ...
          <button onClick={onClose} className="w-8 h-8 rounded-full flex items-center justify-center text-neutral-400 hover:text-white hover:bg-white/10 transition-colors active:scale-95" title="Close" aria-label="Close">
            <X className="w-4 h-4" />
          </button>
        </div>
